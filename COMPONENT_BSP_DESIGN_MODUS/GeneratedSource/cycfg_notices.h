...
#ifndef WLC1115_68LQXQ
    #error "Unexpected target MCU; expected WLC1115-68LQXQ. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
